<%@ page import="com.uraise.webapp.model.ContactType" %>
<%@ page import="com.uraise.webapp.model.ListSection" %>
<%@ page import="com.uraise.webapp.model.OrganizationSection" %>
<%@ page import="com.uraise.webapp.model.SectionType" %>
<%@ page import="com.uraise.webapp.util.DateUtil" %>
                    ...
                    <c:when test="${type=='EXPERIENCE' || type=='EDUCATION'}">
                        <c:forEach var="org" items="<%=((OrganizationSection) section).getOrganizations()%>" varStatus="counter">
                            ...
                            <c:forEach var="pos" items="${org.positions}">
                                <jsp:useBean id="pos" type="com.uraise.webapp.model.Organization.Position"/>
